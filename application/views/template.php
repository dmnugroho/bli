...
<head>
  ...
  <title>Admin Dashboard BLI</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?=base_url()?>assets/index2.html" class="logo">
      ...
      <span class="logo-mini"><b>BLI</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Admin</b>BLI</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?=site_url('auth/profile')?>" class="btn btn-default btn-flat">Profile</a>
                </div>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="#"><i class="fa fa-dashboard"></i><span>Dashboard</a></span></a>
  		</li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-circle-o"></i> Groups User</a></li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2023 &nbsp;&nbsp;<i class="fa fa-envelope"></i> Mail to : dimasmulyanugroho@gmail.com.</strong> All rights
    reserved.
  </footer>  
</div>
<!-- ./wrapper -->
